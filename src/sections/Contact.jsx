...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_254",   // Replace with your EmailJS Service ID
        "template_6uqz4b3",  // Replace with your EmailJS Template ID
        form.current,
        "wsk8GOtBaBos-Ptf0"    // Replace with your EmailJS Public Key (User ID)
      )
      .then(
        (result) => {
